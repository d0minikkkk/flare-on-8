...
with open('..\extracted\\binary_artifacts\\dungeondescription_array.txt','r') as f:
    data = f.read()
...
class TestBot(irc.bot.SingleServerIRCBot):
    ...
    def on_pubmsg(self, c, e):
        ...
        elif 'brew the Potion of Water' in msg:
